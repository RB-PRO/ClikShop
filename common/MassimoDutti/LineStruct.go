...
type Line struct {
	Products []struct {
		...
		BundleColors []struct {
			...
			Name              string        `json:"name"`
			Image             interface{}   `json:"image"`
			ColorName         interface{}   `json:"colorName"`
		...
		RelatedCategories []struct {
			...
			Name        string `json:"name"`
			URLCategory bool   `json:"urlCategory"`
		...
		ProductURL       string      `json:"productUrl"`
		ProductURLParam  string      `json:"productUrlParam"`
		GridElemType     string      `json:"gridElemType"`
		AvailabilityDate string      `json:"availabilityDate"`
		VisibilityValue  string      `json:"visibilityValue"`
		RueiData         struct {
		...
		AlternativeProductID int `json:"alternativeProductId,omitempty"`
	} `json:"products"`
}
